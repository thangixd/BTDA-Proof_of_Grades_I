...
import { Groth16Verifier } from "../typechain-types/contracts/approach_1/verifier.sol";
import { AcademicAward } from "../typechain-types/contracts/approach_1/Award.sol";

import * as proof from "../circuits/build/approach_1/proof.json";
import publicInputs from "../circuits/build/approach_1/public.json"
...
describe("AcademicAward (TypeScript)", function () {
  ...
  beforeEach(async function () {
    ...
    const VerifierFactory = await ethers.getContractFactory(
      "contracts/approach_1/verifier.sol:Groth16Verifier"
    );
    verifier = (await VerifierFactory.deploy()) as Groth16Verifier;
    await verifier.waitForDeployment();
  
    const AcademicAwardFactory = await ethers.getContractFactory("contracts/approach_1/Award.sol:AcademicAward");
